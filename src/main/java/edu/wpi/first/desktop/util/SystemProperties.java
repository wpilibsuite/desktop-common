 ...
 */
public final class SystemProperties extends UtilityClass {
  ...
  /**
   * The name of the JRE that the application is running in.
   */
  public static final String JRE_NAME = System.getProperty("java.runtime.name");

  /**
   * The version of the JRE that the application is running in.
   */
