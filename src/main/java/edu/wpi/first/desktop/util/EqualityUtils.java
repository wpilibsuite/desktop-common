...
/**
 * Utility class for general-purpose object equality checking, with support for normal objects and
 * arbitrarily-dimensioned arrays of objects or primitives.
 */
public final class EqualityUtils extends UtilityClass {
