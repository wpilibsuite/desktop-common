...
public class TypedDataFormat<T> extends DataFormat {
   ...
   *
   * @return the data for the given data format, or <tt>null</tt> if no such data is present in the clipboard
   *
   * @throws ClassCastException if the content in the clipboard for the data format is not of type <tt>T</tt>
   */
