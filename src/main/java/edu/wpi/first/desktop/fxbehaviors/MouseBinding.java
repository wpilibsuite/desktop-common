...
public final class MouseBinding<B extends BehaviorBase<?, B>> extends Binding<MouseEvent, B> {
  ...
  public static final class MouseBindingBuilder<B extends BehaviorBase<?, B>>
    ...
    /**
     * Sets the type of mouse input to fire on. Multiple mouse inputs can be defined for the same binding.
     *
     * @param input the input to fire on
     *
     * @return this builder
     */
     ...
     * Sets the type of mouse input to fire on. Multiple mouse inputs can be defined for the same binding.
     *
     * @param button the mouse button to fire on
     * @param keys   the combination of keys that are pressed
     *
     * @return this builder
     */
     ...
     * Sets the type of mouse input to fire on. Multiple mouse inputs can be defined for the same binding.
     *
     * @param button the button to fire on
     *
     * @return this builder
     */
