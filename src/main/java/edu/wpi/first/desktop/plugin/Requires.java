...
public @interface Requires {
   ...
   * does not have a backward-compatible API with {@code "1.2.3"} - assuming, of course, that the plugin authors are
   * properly following semantic versioning guidelines.
   */
  String minVersion();
}
